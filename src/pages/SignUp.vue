...
<style>
  ...
  .loginpagebg {
    background: url(https://github.com/Sanzro-Lee/HELPER_FACTION_official_background_management_system/blob/master/src/assets/forgetpwbg.png?raw=true) no-repeat;
